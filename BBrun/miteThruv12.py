...
"""
# version du 19/01/20- Avertissement fichier image Full
# version du 24/02/20 - ajout alerte fourmi
 version du 11/06/20 :
	- maj des graphiques facultative
	- main() en nice < 0
	- p1 à p6 en nice > 0
 """
...
camera.framerate = 24
camera.brightness = 50 #70
camera.contrast = 50 #50
